...
ALTER TABLE LIKES
    ADD CONSTRAINT IF NOT EXISTS LIKES_FILM_FK FOREIGN KEY (FILM_ID) REFERENCES FILMS (FILM_ID) ON DELETE RESTRICT ON UPDATE RESTRICT;

ALTER TABLE LIKES
    ADD CONSTRAINT IF NOT EXISTS LIKES_USER_FK FOREIGN KEY (USER_ID) REFERENCES USERS (USER_ID) ON DELETE RESTRICT ON UPDATE RESTRICT;

ALTER TABLE FRIENDS
    ADD CONSTRAINT IF NOT EXISTS FRIENDS_USER_FK FOREIGN KEY (USER_ID) REFERENCES "USERS" (USER_ID);

ALTER TABLE FRIENDS
    ADD CONSTRAINT IF NOT EXISTS FRIENDS_FRIEND_USER_FK FOREIGN KEY (FRIEND_USER_ID) REFERENCES "USERS" (USER_ID);

ALTER TABLE FILM_GENRES
    ADD CONSTRAINT IF NOT EXISTS FILM_GENRES_GENRE_FK FOREIGN KEY (GENRE_ID) REFERENCES GENRES (GENRE_ID) ON DELETE RESTRICT ON UPDATE RESTRICT;
